export class Config {
  ...
  //DELAY SECTION
  //DELAY FOR EACH TX WILL BE RANDOM FROM MIN UNTIL MAX
  static MINDELAYEACHTXINSEC = 10; //MINIMUM DELAY FOR EACH TX
  static MAXDELAYEACHTXINSEC = 120; //MAXIMUM DELAY FOR EACH TX
